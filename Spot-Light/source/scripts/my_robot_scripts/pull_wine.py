...
class _StaticSwingDoor(ControlFunction):
    def __call__(
        ...
        **kwargs,
        ...
        x, y, angle = 1.95, -1.65, 270#-1.5 #large cabinet
        ...
        knob_pose = Pose3D((2.02, -2.45, 1.02))  # -2.47 #large cabinet lower rank
        # knob_pose = Pose3D((1.45, -2.45, 0.57)) # large cabinet, +z
        knob_pose.set_rot_from_rpy((90,0,angle), degrees=True)
